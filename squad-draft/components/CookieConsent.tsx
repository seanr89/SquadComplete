...
const CookieConsent: React.FC = () => {
  ...
  return (
    <>
      {isVisible && !showModal && (
        <div className="fixed bottom-0 left-0 right-0 z-[100] bg-slate-800 border-t border-slate-700 p-4 md:p-6 shadow-2xl animate-in slide-in-from-bottom duration-300">
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2 w-full md:w-auto justify-center">
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-bold bg-slate-700 text-white rounded-lg hover:bg-slate-600 transition-colors"
              >
                Reject All
              </button>
              <button
                onClick={handleAcceptAll}
                className="px-4 py-2 text-sm font-bold bg-yellow-400 text-slate-900 rounded-lg hover:bg-yellow-500 transition-colors shadow-lg shadow-yellow-400/20"
              >
                Accept All
              </button>
            </div>
      ...
      {showModal && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md bg-slate-800 rounded-2xl border border-slate-700 shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="p-4 md:p-6 space-y-6">
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="relative inline-flex h-6 w-11 flex-shrink-0 cursor-not-allowed rounded-full border-2 border-transparent bg-yellow-400 transition-colors duration-200">
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <p className="text-slate-400 text-xs">Help us understand how visitors interact with the website.</p>
                </div>
                <button
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <p className="text-slate-400 text-xs">Used to deliver more relevant advertisements and content.</p>
                </div>
                <button
            ...
            <div className="p-4 md:p-6 bg-slate-800/50 border-t border-slate-700 flex gap-3">
              <button
                onClick={handleRejectAll}
                className="flex-1 py-3 text-sm font-bold bg-slate-700 text-white rounded-xl hover:bg-slate-600 transition-colors"
              >
                Reject All
              </button>
              <button
                onClick={handleSaveSettings}
                className="flex-1 py-3 text-sm font-bold bg-yellow-400 text-slate-900 rounded-xl hover:bg-yellow-500 transition-colors shadow-lg shadow-yellow-400/20"
              >
                Save Preferences
              </button>
            </div>
